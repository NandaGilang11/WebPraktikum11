                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <form name="createForm" @submit.prevent="submit" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <TextInput id="kategori" type="text" class="mt-1 block w-full" v-model="form.kategori" required
                                autocomplete="off" />
                        ...
                        <div>
                            ...
                            <TextInput id="konten" type="text" class="mt-1 block w-full" v-model="form.konten" required
                                autocomplete="off" />
                        ...
                        <div>
                            ...
                            <TextInput id="konten" type="text" class="mt-1 block w-full" v-model="form.penulis" required
                                autocomplete="off" />
